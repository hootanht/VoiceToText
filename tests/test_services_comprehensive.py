...
class TestGeminiAnalyzerComprehensive(unittest.TestCase):
    ...
    @patch('services.gemini_analyzer.genai')
    def test_analyze_audio_success(self, mock_genai):
    ...
    @patch('services.gemini_analyzer.genai')
    def test_analyze_audio_api_error(self, mock_genai):
        ...
        with self.assertRaises(Exception):
            self.analyzer.analyze_audio(test_file, "persian")
...
class TestReportGeneratorComprehensive(unittest.TestCase):
    ...
    def test_generate_analysis_report_complete(self):
        ...
        audio_file = AudioFile("test.mp3", "", 1024)  # Let __post_init__ set the name
    ...
    def test_generate_summary_report_empty_results(self):
        ...
        self.assertIsInstance(summary, str)
        self.assertGreater(len(summary), 0)
        self.assertIn("No", summary)  # Should indicate no results
